...
const tokenizationSpecification = {
    ...
    "parameters": {
      ...
      "stripe:publishableKey": "pk_test_lwA7rd9PKOMVMBALROik4wdf"
    }
  };
...
function processPayment(paymentData) {
  ...
  // parse paymentData into json type
  var formData = JSON.parse(paymentData.paymentMethodData.tokenizationData.token);
  console.log(formData);
  const google_php_url = 'http://googlepaytest/paymenttest.php';
  $.ajax({
    type : 'post',
    data: formData,
    url : google_php_url,
    success : function(data) {
      console.log('google pay is successful');
    },
    error : function(xhr, textStatus, errorThrown) {
      console.log('fail');
      // deal with the error information
